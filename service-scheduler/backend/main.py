...
from app.api import auth, slots, bookings
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting up Service Scheduler API...")
    try:
        await init_db()
    ...
    # Shutdown
    logger.info("Shutting down Service Scheduler API...")


# Create FastAPI application
app = FastAPI(
    title="Service Scheduler API",
    description="A comprehensive service scheduling application with role-based access control",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan
